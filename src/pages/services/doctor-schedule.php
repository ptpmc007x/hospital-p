...
<body>
    ...
    <main>
        ...
        <body>
            <div class="container">
                <div>
                    <h4 class="txt">ตารางแพทย์ออกตรวจ</h4>
                </div>
                <br>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">คลินิกผู้ป่วยนอก</th>
                            <th scope="col">เวลา/ทำการ</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>ผู้ป่วยนอก</td>
                            <td>9.00-16.00 u.</td>
                            <td>ชั้น 2 อาคารสยามบรมราชกุมารี</td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td>คลินิกโรคภูมิแพ้ ภูมิคุ้มกันและโรคข้อ</td>
                            <td>อังคาร / พฤหัสฯ 9.00-12.00 u</td>
                            <td>ชั้น 12 อาคารเฉลิมพระเกียรติฯ</td>
                        </tr>
                        <tr>
                            <th scope="row">3</th>
                            <td>คลินิกโรคภูมิแพ้ ภูมิคุ้มกันและโรคข้อ</td>
                        ...
                        <tr>
                            <th scope="row">4</th>
                            <td>คลินิกโรคหัวใจ</td>
                            <td>ทุกวันพุธ  8.00-12.00 u.</td>
                            <td>ชั่น 2 อาคารสยามฯ</td>
                        </tr>
                        <tr>
                            <th scope="row">5</th>
                            <td>คลินิกจิตเวชเด็กและวัยรุ่น</td>
                            <td>จันทร์ - ศุกร์ 7.30-16.00 u</td>
                            <td>ชั้น 12A อาคารเฉลิมพระเกียรติฯ</td>
                        </tr>
                        <tr>
                            <th scope="row">6</th>
                            <td>คลินิกพัฒนาการคลินิกกระตุ้นพัฒนาการ</td>
                            <td>จันทร์ - ศุกร์ 9.00-12.00 u.</td>
                            <td>ชั้น 3 อาคารสยาม</td>
                        </tr>
                        <tr>
                            <th scope="row">7</th>
                            <td> คลินิกทันตกรรม</td>
                            <td>จันทร์ - ศุกร์ 8.00-16.00 u.</td>
                            <td>ชั้น 12 อาคารเฉลิมพระเกียรติฯ</td>
                        </tr>
                        <tr>
                            <th scope="row">8</th>
                            <td>คลินิก หู คอ จมูก คลินิกตรวจการได้ยิน คลินิกฝึกพูด</td>
                            <td>จันทร์ - ศุกร์ 8.00-16.00 u.</td>
                            <td>ชั้น 11 อาคารเฉลิมพระเกียรติฯ</td>
                        </tr>
                        <tr>
                            <th scope="row">9</th>
                            <td>คลินิกโรคผิวหนัง</td>
                            <td>จันทร์/พุธ/พฤหัสฯ 16.00-20.00 u</td>
                            <td>ชั้น 2 อาคารสยามบรมราชกุมารี</td>
                        </tr>
                        <tr>
                            <th scope="row">10</th>
                            <td>คลินิกโรคต่อมไร้ท่อคลินิกโรคต่อมไร้ท่อ ผู้ป่วยใหม่ เบาหวานในเด็กและวัยรุ่น</td>
                            <td>จันทร์ - ศุกร์ 8.00 - 12.00 น</td>
                            <td>ชั้น 2 อาคารสยาม</td>
                        </tr>
                        <tr>
                            <th scope="row">11</th>
                            <td>คลิกนิกศัลยกรรมทั่วไป</td>
                            <td>พฤหัสฯ 9.00-16.00 u.</td>
                            <td>ชั้น 2 อาคารสยาม</td>
                        </tr>
                        <tr>
                            <th scope="row">12</th>
                            <td>คลินิกโรคระบบทางเดินอาหารและตับ</td>
                            <td>จันทร์/พุธ จันทร์ 8.00-12.00 u.</td>
                            <td>ชั้น 12 อาคารเฉลิมพระเกียรติฯ</td>
                        </tr>
                    </tbody>
                </table>
