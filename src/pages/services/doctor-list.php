...
<body>
    ...
    <div class="container">
        ...
        <div class="card mx-auto" style="width: 18rem; text-align: center;">
            <img src="https://placehold.co/300x400" class="card-img-top" alt="...">
            <div class="card-body">
                <p class="card-text">นายแพทย ์กิติศักดิ์ เกษตรสินสมบัติ</p>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-md-3">
                <img src="https://placehold.co/150x200" class="img-thumbnail" alt="...">
            </div>
            <div class="col-md-3">
                <img src="https://placehold.co/150x200" class="img-thumbnail" alt="...">
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <a href="Image20240302151739.jpg">
                    <img src="Image20240302151739.jpg" alt="Fjords" style="width:100%">
                    <div class="caption">
                        <p>Lorem ipsum...</p>
                    </div>
                </a>
